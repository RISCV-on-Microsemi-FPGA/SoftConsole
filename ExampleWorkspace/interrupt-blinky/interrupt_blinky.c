 ...
 *
 * This is simple example of using an external interrupt. We use a CoreTimer
 * instance which interrupt is connected to interrupt 30 of the processor to
 * generate an interrupt at regular interval.
 * The interrupt service routine toggles some of the GPIO outputs connected to
 * LEDs.
 *
 */
#include <stdlib.h>
...
int main(int argc, char **argv)
{
    ...
    /*
     * In this version of the PLIC, the priorities are fixed at 1. Lower
     * numbered devices have higher priorities. But this code is given as an
     * example.
     */
